...
const Header = () => {
  ...
  const switchBorderColor = "border-[#E7E7EB] dark:border-homeTwoPrimary";
  const switchBgColor = "bg-homeTwoPrimary";
  ...
  const borderColor = "border-homeTwoPrimary";
  const iconColor = "text-homeTwoPrimary group-hover:text-[#FFFFFF]";
  const borderRadius = "rounded-none";

  return (
    <header className="max-h-[818px] max-w-[1920px] mx-auto">
      <Container>
                ...
                >
                  ...
                  >
                    {item.submenu.map((subitem, index) => (
                      <li
                        key={index}
                        className="whitespace-nowrap hover:bg-homeTwoPrimary hover:text-[#10171E] py-2 px-4"
                      >
                        <NavLink
                          to={subitem.href}
                          end
            ...
            <div className="xl:hidden">
              ...
              >
                <FontAwesomeIcon
                  ...
                  className="text-[30px] md:text-[40px] text-homeTwoPrimary"
                />
              </button>
                          ...
                          <>
                            ...
                            >
                              {item.submenu.map((subitem, index) => (
                                <li
                                  key={index}
                                  className="whitespace-nowrap text-[#FFFFFF] hover:bg-homeTwoPrimary hover:text-[#10171E] py-2 px-4"
                                >
                                  <NavLink
                                    to={subitem.href}
                                    end
